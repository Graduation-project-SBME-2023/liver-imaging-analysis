...
class Preprocessing():
    def __init__(self, keys, size):
        ...
        self.transform = Compose([
            ...
            # RandFlipd(keys, prob=0.4, spatial_axis=2),
            # RandRotated(keys, range_x=0.5, range_y=0.5, range_z=0.5, prob=0.4, keep_size=True),
...
class DataLoader():
    def __init__(self, dataset_path, batch_size, num_workers=0,
        ...
        training_volume_path=volume_paths
        training_mask_path=mask_paths
